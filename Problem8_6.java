...
public class Problem8_6 {
    static final double[] ansArray = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
        ...
        if (checkAn(bunsi, bunbo) == true) {
            ...
            if (bunsi > bunbo) {
                if (gcd(bunsi, bunbo) != 1) {
                    ...
                    System.out.println(bunsi1 + "/" + bunbo1 + "+" + bunsi2 + "/" + bunbo2 + "=" + (xBunsi / xBunbo)
                            + "." + (xBunsi % xBunbo) + "/" + xBunbo);
                } else {
                ...
                if (gcd(bunsi, bunbo) != 1) {
                    ...
                    System.out
                            .println(bunsi1 + "/" + bunbo1 + "+" + bunsi2 + "/" + bunbo2 + "=" + yBunsi + "/" + yBunbo);
                } else {
                    System.out.println(bunsi1 + "/" + bunbo1 + "+" + bunsi2 + "/" + bunbo2 + "=" + bunsi + "/" + bunbo);
                }
            }
    ...
    static boolean checkAn(int bunsi, int bunbo) {
        ...
        // if (ans == 1.0 || ans == 2.0 || ans == 3.0 || ans == 4.0 || ans == 5.0 || ans
        // == 6.0 || ans == 7.0 || ans == 8.0
        // || ans == 9.0) {
        // return true;
        // }

        for (double target : ansArray) {
            if (ans == target) {
                return true;
            }
        }
